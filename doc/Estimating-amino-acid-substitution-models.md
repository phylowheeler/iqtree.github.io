...
GTRspmix is a protein mixture model with multiple exchangeability matrices (GTRs) and profiles ([Harada et al., 2026]). Profiles are clustered into several groups, with each profile cluster linked to a unique exchangeability matrix.
...
> __R. Harada et al.__ (2026) GTRspmix: Capturing Heterogeneity of Exchangeabilities Across Sites to Improve Protein Phylogenetics. _bioRxiv_ <https://doi.org/10.64898/2026.06.18.729217>
